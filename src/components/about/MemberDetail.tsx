    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-500 bg-opacity-70">
      ...
      >
        ...
        <motion.div
          ...
          className="hover:cursor absolute right-[10%] top-[5%] cursor-pointer font-bungee-hairline text-xl text-white text-stroke-white stroke-weight-[2px] md:text-2xl md:stroke-weight-[3px]"
        ...
        {/* Main content */}
        <div className="mx-auto mt-5 flex max-h-[100%] min-h-[80%] w-[75%] flex-col gap-2 sm:mt-0 md:gap-5 lg:gap-10">
            ...
            <div className="flex flex-col items-center justify-center gap-4 md:flex-row">
              ...
              <div className="text-md flex w-[67%] flex-col text-wrap text-left font-jost text-white md:ml-4 md:text-xl">
                ...
                <div className="mt-1 flex flex-row items-center md:mt-4">
                  ...
                  <div className="mb-1 h-2 w-2 rotate-45 transform bg-white sm:mb-3 sm:mr-5 md:h-3 md:w-3 lg:mb-4"></div>
                </div>
              </div>
            </div>
