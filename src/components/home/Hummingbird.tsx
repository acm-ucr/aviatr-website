      ...
      {isMobile ? (
        <div className="mx-[5%] mt-[12%] grid grid-cols-10">
          <div className="col-span-10 grid content-center lg:col-span-4">
            ...
            <div className="text-md mx-[10%] mb-[8%] flex flex-col gap-8 font-jost leading-relaxed text-white sm:text-xl lg:mx-0 lg:pl-[10%]">
              <p>
        ...
        <div className="mx-[5%] mt-[8%] grid grid-cols-10">
          ...
          <div className="col-span-10 grid content-center lg:col-span-4">
            <div className="mb-[12%] ml-[4%] mt-[6%] sm:ml-0 lg:ml-[14%] lg:mt-0">
              <ShiftedLineTitle
                title="Hummingbird"
                width="md:w-[90%]"
                textSize="lg:text-5xl"
            ...
            <div className="text-md mx-[10%] flex flex-col gap-8 font-jost leading-relaxed text-white sm:text-xl lg:mx-0 lg:pl-[10%]">
              <p>
                Project Hummingbird is a research team aimed at improving
                existing systems or creating new processes and mechanisms to
                pioneer the future. With the current team aimed at improving
